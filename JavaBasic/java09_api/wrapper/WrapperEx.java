...
public class WrapperEx {
	public static void main(String[] args) {
		...
		Integer iVal1 = new Integer(100); //Wrapper 클래스 정수형을 객체화
		...
		double d1 = 123.456; // 기본데이터타입 double
		
		Double dVal1 = new Double( d1 ); // 박싱, Boxing
		Double dVal2 = new Double("45.678"); // 박싱, Boxing
...
//		 숫자만을 가지고 있지 않아서 나타나는 예외
		...
		// parseBoolean() 은 "true"만 제대로 파싱하고 나머지는 전부 다 false로 반환한다
		String data = "true";
//		String data = "adfefefe"; // false
//		String data = "false"; // false
		...
		// 파싱은 아니지만 문자열에서 단일문자(char) 데이터를 분리할 때 charAt(index) 메소드를 사용한다
		
		System.out.println("------------------------");

		System.out.println( Integer.MAX_VALUE ); // int 형의 최대값
		System.out.println( Integer.MIN_VALUE ); // int 형의 최소값
